...
import com.csx4109.assignment.databinding.ItemForListBinding
import com.csx4109.assignment.models.Game
import com.squareup.picasso.Picasso

class ListAdapter(private val context: Context, private val games: List<Game>)
    : RecyclerView.Adapter<ListAdapter.ListHolder>() {

    class ListHolder(val binding: ItemForListBinding) : RecyclerView.ViewHolder(binding.root)

    override fun getItemCount(): Int = games.size

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListHolder {
        val layoutInflater = LayoutInflater.from(context)
        val binding = ItemForListBinding.inflate(layoutInflater, parent, false)
